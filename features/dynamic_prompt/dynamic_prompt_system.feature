...
Feature: dynamic_prompt_system
    ...
    So that I can have the most appropriate way to handle the missing person with minimum disruption and unwanted incidence
...
@happy_path
Scenario: User click to see third answer generated by dynamic prompt system
    Given I am logged in as general public
    And I am on Post Detail page for missing person name "David"
