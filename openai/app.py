...
def generate_prompt(text_data):
    prompt = "This is a text about a missing person. Based on this specific text, in a paragraph format, give me advice on what to look out for and how to interact with this missing individual if I spot them. {}".format(text_data)
    return prompt
